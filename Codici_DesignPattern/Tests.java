...
public class Tests {
    ...
    public void ex06_upcaseOddLengthWords() {
        ...
        List<String> result = stream; // TODO
    ...
    /**
     * Read the words from the text file, and create a list containing the words
     * of length 8 or longer, converted to lower case, and sorted reverse
     * alphabetically.
    ...
    // Hint 2:
    // <editor-fold defaultstate="collapsed">
    // Use LongAdder or AtomicLong/AtomicInteger to allow peek() to have side
    // effects.
    // </editor-fold>
     ...
     * map from the first letter of the word to an inner map. (Use a string of
     * length
    ...
    // a "downstream" collector that's the same operation as the first-level
    // collector.
    // </editor-fold>
    // Hint 2:
    // <editor-fold defaultstate="collapsed">
     ...
     * by inserting the input string at both the beginning and end. For example,
     * given
    ...
    /**
     * Denormalize this map. The input is a map whose keys are the number of legs of
     * an animal
     * and whose values are lists of names of animals. Run through the map and
     * generate a
    ...
    /**
     * Provide lambda expressions for the peek() operations that enable you to
     * detect
     * whether the stream is running in parallel, and using this information,
     * provide
     ...
     * solutions for this; the solutions file contains only one example.) Race
     * conditions
    ...
    // Hint 1:
    // <editor-fold defaultstate="collapsed">
    // By its very nature, you need to do something with side-effects within
    // Stream.peek().
    // </editor-fold>
    // Hint 2:
    // <editor-fold defaultstate="collapsed">
